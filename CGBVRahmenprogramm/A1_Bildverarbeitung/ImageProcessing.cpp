...
void InitGUI()
{
	...
	const TwEnumVal imgEV[] = { { 0, "Erde" }, { 1, "Erde SW" }, { 2, "TajMahal" }, { 3, "Zonenplatte" }, { 4, "Taschenrechner" }, { 5, "Block" }, { 6, "Parts" }, { 7, "Rice" } };

	TwType shaderType = TwDefineEnumFromString("ShaderType", enumString.c_str());
	TwType imgType = TwDefineEnum("ImageType", imgEV, 8);
